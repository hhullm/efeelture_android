...
public class MainActivity_music extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		b_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				MainActivity_music.this.finish();

			}
		});
		//启动服务�?
		Intent mintent=new Intent();
		mintent.setClass(MainActivity_music.this, MyService.class);
