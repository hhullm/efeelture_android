...
public class fragment2_2 extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		view = getActivity().getLayoutInflater().inflate(R.layout.activity_main_contact, null);
	...
	private void initData() {
		...
		sortListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Toast.makeText(getActivity(), number, 0).show();
			}
		});
	...
	private class ConstactAsyncTask extends AsyncTask<Integer, Integer, Integer> {
		...
		protected Integer doInBackground(Integer... arg0) {
			int result = -1;
			callRecords = ConstactUtil.getAllCallRecords(getActivity());
			result = 1;
			return result;
		}
		@Override
